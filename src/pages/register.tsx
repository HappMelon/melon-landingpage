...
export default function Register() {
  ...
  return (
    <div className="w-[397px] h-[562px] top-[238px] left-[762px] ">
      ...
      <h1 
      className="w-[275px] h-[20px] absolute top-[367px] left-[818px] font-avenir font-semibold text-[20px] leading-[20px] tracking-normal text-left text-black">Create Your Flare Account
        </h1>
      ...
      <div className="w-[397px] h-[65px] absolute top-[502px] left-[762px] rounded-[10px]"> 
        <lable className="w-[70px] h-[19px] top-[502px] left-[762px] font-avenir font-[16px] font-semibold leading-[19px] tracking-normal text-left">Password:</lable>
        <input type="password"  
